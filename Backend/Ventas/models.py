...
class Pedido(models.Model):
    ...
    cuf = models.CharField(max_length=200, blank=True, null=True)  # CUF del SIAT
    ...
    estado_factura = models.CharField(max_length=50, default='Pendiente')  # Pendiente, Enviado, Aceptado, Rechazado
