...
from accounts.controllers.plan_controller import (
    ...
    UsuarioConPlanView,
    SincronizarUsuarioPlanView
)
from backend.permisos import VerificarPermisosEmpleado

from accounts.controllers.permisos_controller import PermisosListCreate
urlpatterns = [
    # Autenticación
    ...
    path('usuarios/<int:usuario_id>/sincronizar-plan/', SincronizarUsuarioPlanView.as_view(), name='sincronizar-plan'),
    ...
    # Permisos
    path('permisos/', PermisosListCreate.as_view(), name='permisos-list-create'),
    path('permisos/<int:permiso_id>/', PermisosListCreate.as_view(), name='permiso-detail'),
    ...
    path('empleados/<int:empleado_id>/permisos/', VerificarPermisosEmpleado.as_view(), name='verificar-permisos'),
    path('empleados/<int:empleado_id>/permisos/<str:permiso_nombre>/', 
         VerificarPermisosEmpleado.as_view(), name='verificar-permiso-especifico'),
