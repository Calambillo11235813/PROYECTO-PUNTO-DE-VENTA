...
class UsuarioService {
  static const String _baseUrl = 'http://18.117.138.19:8000/accounts';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (usuario != null && usuario['id'] != null) {
          GlobalStorage.userId = usuario['id'];
          print('🆔 ID de usuario guardado: ${GlobalStorage.userId}');
        }
        ...
        // Empresa (si la respuesta la contiene)
        ...
        print('✅ Login exitoso y datos guardados');
        return true;
      } else {
