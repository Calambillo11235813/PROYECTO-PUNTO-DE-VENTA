  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF55B84B), // Color de fondo
      ),
      body: Center(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF55B84B), // Color verde en AppBar
      ),
            ...
            children: const [
              Text(
                ...
                style: TextStyle(
                  ...
                  color: Color(
                    0xFF333333,
                  ), // Texto oscuro para contraste con el fondo
                ),
              ),
              SizedBox(height: 16),
              Text(
