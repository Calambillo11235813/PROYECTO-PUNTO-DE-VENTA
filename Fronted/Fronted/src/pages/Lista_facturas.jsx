            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg md:max-w-xl lg:max-w-2xl sm:w-full">
              ...
              <div className="bg-white p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div>
                    <h4 className="text-sm font-medium text-gray-500">INFORMACIÓN DE LA FACTURA</h4>
                    ...
                    {selectedFactura.estado === 'Anulado' && selectedFactura.motivo_anulacion && (
                      <p className="mt-1 flex items-start">
                        <span className="font-medium text-gray-600">Motivo anulación:</span>
                        <span className="ml-2 text-gray-800">{selectedFactura.motivo_anulacion}</span>
                      </p>
                    )}
                  </div>
                  <div>
                ...
                {selectedFactura.cuf && (
                  <div className="mt-4 p-3 bg-gray-50 rounded-md overflow-hidden">
                    <p className="flex flex-col">
                      <span className="font-medium text-gray-600">CUF (Código Único de Factura):</span>
                      <span className="text-xs text-gray-800 overflow-x-auto">{selectedFactura.cuf}</span>
                    </p>
                  </div>
                )}
                ...
                <div className="mt-6 bg-gray-50 p-4 rounded-md">
                  <div className="flex justify-between items-center mt-2">
                    ...
                    <span className="text-sm text-gray-800">
                      {formatCurrency(selectedFactura.monto_subtotal || 0)}
                    </span>
                  </div>
                  <div className="flex justify-between items-center mt-2">
                    <span className="text-sm font-medium text-gray-600">Descuentos:</span>
                    <span className="text-sm text-gray-800">
                      {formatCurrency(selectedFactura.monto_descuento || 0)}
                    </span>
                  </div>
